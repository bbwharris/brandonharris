# Quickly hacked together by Brandon Harris
# Based on mephisto.rb by Michael Ivey, open source and publically
...
module Jekyll
  module Enki
    ...
    QUERY = "SELECT id, slug, body_html, published_at, title FROM posts ORDER BY published_at"
